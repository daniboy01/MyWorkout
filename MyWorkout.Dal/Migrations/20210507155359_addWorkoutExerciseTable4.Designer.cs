...
namespace MyWorkout.Dal.Migrations
{
    ...
    [Migration("20210507155359_addWorkoutExerciseTable4")]
    partial class addWorkoutExerciseTable4
    {
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 202, DateTimeKind.Unspecified).AddTicks(8693), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 206, DateTimeKind.Unspecified).AddTicks(6594), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 2
                        },
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 206, DateTimeKind.Unspecified).AddTicks(6644), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 3
                        },
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 206, DateTimeKind.Unspecified).AddTicks(6655), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 206, DateTimeKind.Unspecified).AddTicks(6662), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 53, 59, 206, DateTimeKind.Unspecified).AddTicks(6670), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 1,
                            WorkoutPlanId = 1
                        });
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "59381da7-5301-4fcc-99fc-afa6342d876e",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3c149d49-4c20-45e2-8b65-c8303974f48e",
                        ...
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "473975f6-1e07-4965-9f6c-b6259bb8906f",
