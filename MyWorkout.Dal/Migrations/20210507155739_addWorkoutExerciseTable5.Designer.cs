...
namespace MyWorkout.Dal.Migrations
{
    ...
    [Migration("20210507155739_addWorkoutExerciseTable5")]
    partial class addWorkoutExerciseTable5
    {
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 265, DateTimeKind.Unspecified).AddTicks(558), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 269, DateTimeKind.Unspecified).AddTicks(5758), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 2
                        },
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 269, DateTimeKind.Unspecified).AddTicks(5833), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 3
                        },
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 269, DateTimeKind.Unspecified).AddTicks(5843), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 269, DateTimeKind.Unspecified).AddTicks(5850), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 7, 17, 57, 39, 269, DateTimeKind.Unspecified).AddTicks(5857), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 1,
                            WorkoutPlanId = 1
                        });
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c3361248-728d-43d8-bbf5-e2cbb46ddfbe",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b271a5ea-63ac-4ced-b834-f62f865b9726",
                        ...
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fb6a9439-2084-4fa9-8630-7f7e8ab92641",
