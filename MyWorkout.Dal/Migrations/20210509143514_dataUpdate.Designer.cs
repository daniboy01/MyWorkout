...
namespace MyWorkout.Dal.Migrations
{
    ...
    [Migration("20210509143514_dataUpdate")]
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 46, DateTimeKind.Unspecified).AddTicks(4475), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 50, DateTimeKind.Unspecified).AddTicks(910), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 2
                        },
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 50, DateTimeKind.Unspecified).AddTicks(969), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 3
                        },
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 50, DateTimeKind.Unspecified).AddTicks(980), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 3,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 50, DateTimeKind.Unspecified).AddTicks(988), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 9, 16, 35, 14, 50, DateTimeKind.Unspecified).AddTicks(996), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 1,
                            WorkoutPlanId = 1
                        });
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ec3fdeee-2ab0-440c-9399-0309bbdbc8c8",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "332c403a-f87a-45b4-8180-ae3607596648",
                        ...
                        new
                        {
                            Id = 3,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "570ba2d3-4b99-4343-b829-57c336df1684",
