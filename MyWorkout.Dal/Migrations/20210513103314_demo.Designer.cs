            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 13, 12, 33, 13, 839, DateTimeKind.Unspecified).AddTicks(775), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 13, 12, 33, 13, 842, DateTimeKind.Unspecified).AddTicks(6133), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 2
                        },
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 13, 12, 33, 13, 842, DateTimeKind.Unspecified).AddTicks(6186), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 2,
                            WorkoutPlanId = 1
                        },
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTimeOffset(new DateTime(2021, 5, 13, 12, 33, 13, 842, DateTimeKind.Unspecified).AddTicks(6195), new TimeSpan(0, 2, 0, 0, 0)),
                            Text = "Ez aztán durva edzés terv",
                            UserID = 1,
                            WorkoutPlanId = 1
                        });
            ...
            modelBuilder.Entity("MyWorkout.Dal.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "555ae822-84d0-4165-be6d-41b38b4135b0",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "65083fbe-52a1-4feb-8b79-5c0ce57266eb",
